...
<div class="header-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="logo">
                    <a href="index.php"><img src="statics/images/erick.png" alt=""></a>
                </div><!-- end logo -->
            </div>
        </div><!-- end row -->
    </div><!-- end header-logo -->
        ...
        <nav class="navbar navbar-inverse navbar-toggleable-md">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link color-green-hover" href="category.php">Programming</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link color-green-hover" href="category.php">Videos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link color-green-hover" href="category.php">Products</a>
                    </li>
                    <li class="nav-item">
